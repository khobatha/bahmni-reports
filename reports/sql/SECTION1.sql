SELECT Heading,	   
 IFNULL(SUM(IF(Persons = 'Children' AND Gender = 'M', 1, 0))) AS Children_Males, 
 IFNULL(SUM(IF(Persons = 'Children' AND Gender = 'F', 1, 0))) AS Children_Females,
 IFNULL(SUM(IF(Persons = 'Adults' AND Gender = 'M', 1, 0))) AS Adults_Males, 
 IFNULL(SUM(IF(Persons = 'Adults' AND Gender = 'F', 1, 0))) AS Adults_Females
