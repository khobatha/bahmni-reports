    ...
    FROM(    
        ...
        FROM(
            select distinct o.person_id AS Id,
                            ...
                            floor(datediff(CAST('2020-05-31' AS DATE), person.birthdate)/365) AS Age,
            ...
            CAST('2020-05-31' AS DATE) BETWEEN (DATE_ADD(DATE_ADD(person.birthdate, INTERVAL observed_age_group.min_years YEAR), INTERVAL observed_age_group.min_days DAY))
            AND (DATE_ADD(DATE_ADD(person.birthdate, INTERVAL observed_age_group.max_years YEAR), INTERVAL observed_age_group.max_days DAY))
            WHERE observed_age_group.report_group_name = 'Modified_Ages'
            AND o.voided = 0
            AND MONTH(obs_datetime) = MONTH(CAST('2020-05-31' AS DATE)) 
            AND YEAR(obs_datetime) = YEAR(CAST('2020-05-31' AS DATE))
